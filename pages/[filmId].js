...
import { ThumbDownIcon, EyeIcon, ThumbUpIcon } from '@heroicons/react/outline';
import Image from 'next/image';


function FilmDetali({ result }) {
         ...
         <div className='px-5 my-10 sm:grid md:grid xl:grid 3xl:grid justify-center'>
            <div
               ...
               <div className='p-2'>
                  ...
                  <h2 className='mt-1 text-xl text-white transition-all duration-100 ease-in-out group-hover:font-bold'>Average grade: {result.vote_average}</h2>
...
export default FilmDetali;


export async function getServerSideProps(context) {
   const movieId = context.query.filmId;
   ...
   //_With params aproach________________________
   // const { params } = context;

   // const request = await fetch(`https://api.themoviedb.org/3/movie/${params}?api_key=38940c671b10b250dd4b31b08ddd9bd3&language=en-US`)
   // const data = await request.json()
